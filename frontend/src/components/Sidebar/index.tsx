          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <MdOutlineDashboard className="fill-current text-xl" />{' '}
                  Dashboard
                </NavLink>
              </li>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            ...
                            >
                              <MdBusiness className="fill-current text-xl" />{' '}
                              Companies List
                            </NavLink>
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            >
                              <MdAddBusiness className="fill-current text-xl" />{' '}
                              Add Company
                            </NavLink>
                          </li>
                        </ul>
              ...
              {allowedRoles(['super_admin', 'tenatnt_admin']) && (
                <li>
                  ...
                  >
                    <MdOutlineLeaderboard className="fill-current text-xl" />
                    All Leads
                  </NavLink>
                </li>
              )}
              ...
              {allowedRoles(['super_admin', 'tenatnt_admin']) && (
                <li>
                  ...
                  >
                    <MdPayment className="fill-current text-xl" />
                    Payments History
                  </NavLink>
                </li>
              )}
              ...
              {allowedRoles(['super_admin']) && (
                <li>
                  ...
                  >
                    <CiViewList className="fill-current text-xl" />
                    Packages
                  </NavLink>
                </li>
              )}
                          ...
                          >
                            <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                              ...
                              <li>
                                ...
                                >
                                  Insert Lead Mannually
                                </NavLink>
                              </li>
                              <li>
                                <NavLink
                                  to="/add-lead-provider"
                                  className={({ isActive }) =>
                                    'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                    (isActive && '!text-white')
                                  }
              ...
              {allowedRoles(['super_admin', 'tenatnt_admin']) && (
                <li>
                  ...
                  >
                    <MdOutlineContactSupport className="fill-current text-xl" />
                    Support
                  </NavLink>
                </li>
              )}
              ...
              {allowedRoles(['super_admin', 'tenatnt_admin']) && (
                <li>
                  <NavLink
                    to="/emailtemplates"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('emailtemplates') &&
                      'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <MdOutlineAttachEmail className="fill-current text-xl" />
                    Email Management
                  </NavLink>
                </li>
              )}
              ...
              {allowedRoles(['tenatnt_admin']) && (
                <SidebarLinkGroup
                  activeCondition={
                    ...
                    //TODO Add all routes of  sub menu items
                  }
                >
                  {(handleClick, open) => (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            ...
                            >
                              <MdOutlineFireTruck className="fill-current text-xl" />{' '}
                              Trucks
                            </NavLink>
                          </li>
                          <li>
                            ...
                            >
                              <MdOutlineInventory2 className="fill-current text-xl" />{' '}
                              Inventory
                            </NavLink>
                          </li>
                          <li>
                            ...
                            >
                              <MdFactory className="fill-current text-xl" />{' '}
                              Materials
                            </NavLink>
                          </li>
                          <li>
                            ...
                            >
                              <MdOutlinePayments className="fill-current text-xl" />{' '}
                              Deposits
                            </NavLink>
                          </li>
                          <li>
                            ...
                            >
                              <MdOutlineDiscount className="fill-current text-xl" />{' '}
                              Discounts
                            </NavLink>
                          </li>
                          <li>
                            ...
                            >
                              <MdOutlineSecurity className="fill-current text-xl" />{' '}
                          ...
                          <li>
                            ...
                            >
                              <MdBuild className="fill-current text-xl" />{' '}
                              Additional Services
                            </NavLink>
                          </li>
                          <li>
                            ...
                            >
                              <MdOutlineDocumentScanner className="fill-current text-xl" />{' '}
                              Agreement
                            </NavLink>
                          </li>
                          <li>
                            ...
                            >
                              <MdOutlineSubscriptions className="fill-current text-xl" />{' '}
                              Subscription
                            </NavLink>
                          </li>
                          <li>
                            ...
                            >
                              <MdOutlinePointOfSale className="fill-current text-xl" />{' '}
                              Point of Sales
                            </NavLink>
                          </li>
                        </ul>
