...
const handleSignIn = async (event: React.FormEvent<HTMLFormElement>) => {
  ...
  try {
    ...
    // Dispatch the accessToken and userData to the Redux store
  ...
  return (
    <div className=''>
       <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark lg:py-6">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              />
                    ...
                    <AiOutlineMail className='text-2xl text-[#acacac] ' />
                    </span>
                  </div>
                </div>
              ...
              />
                    ...
                    <span className="absolute right-4 top-4">
                      <button
                        ...
                        {showPassword ? <FaEyeSlash className='text-xl text-[#acacac]'/> : <FaEye className='text-xl text-[#acacac]'/>}
                      </button>
                    </span>
                  </div>
                </div>
