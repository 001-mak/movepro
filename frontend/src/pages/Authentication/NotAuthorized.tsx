...
import Logo from '../../images/illustration/illustration-01.svg';

const NotAuthorized: React.FC = () => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="rounded-sm border border-stroke p-10 bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="mx-auto text-center">
              <img src={Logo} alt="illustration" width={400} height={400} />
